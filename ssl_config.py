...
CLIENT_CERT_PATH = Path("/etc/frame-render-svc/client.crt")
CLIENT_KEY_PATH = Path("/etc/frame-render-svc/client.key")
...
def load_client_ssl() -> ssl.SSLContext:
    ...
    Notes:
      * The cert at /etc/frame-render-svc/client.crt was issued for one year and
